...
test("plugin API configuration and automatic production migration are fail-closed", () => {
  ...
  const ready = productionReadinessIssues(readyEnvironment({
    ...
    PLUGIN_DESKTOP_RELEASE_URL: "https://3dipl.org/downloads/3dipl-desktop-0.3.0.zip",
    ...
    PLUGIN_MAX_BRIDGE_RELEASE_URL: "https://3dipl.org/downloads/3dipl-bridge-0.3.0.mzp",
